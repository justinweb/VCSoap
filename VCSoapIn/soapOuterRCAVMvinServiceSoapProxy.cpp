...
int OuterRCAVMvinServiceSoapProxy::DoOuterRCAVMvin(const char *endpoint, const char *soap_action, _ns1__DoOuterRCAVMvin *ns1__DoOuterRCAVMvin, _ns1__DoOuterRCAVMvinResponse &ns1__DoOuterRCAVMvinResponse)
{	struct soap *soap = this;
	struct __ns1__DoOuterRCAVMvin soap_tmp___ns1__DoOuterRCAVMvin;
	if (endpoint)
		soap_endpoint = endpoint;
	...
	soap_tmp___ns1__DoOuterRCAVMvin.ns1__DoOuterRCAVMvin = ns1__DoOuterRCAVMvin;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___ns1__DoOuterRCAVMvin(soap, &soap_tmp___ns1__DoOuterRCAVMvin);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns1__DoOuterRCAVMvin(soap, &soap_tmp___ns1__DoOuterRCAVMvin, "-ns1:DoOuterRCAVMvin", "")
	...
	if (!static_cast<_ns1__DoOuterRCAVMvinResponse*>(&ns1__DoOuterRCAVMvinResponse)) // NULL ref?
		return soap_closesock(soap);
	ns1__DoOuterRCAVMvinResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__DoOuterRCAVMvinResponse.soap_get(soap, "ns1:DoOuterRCAVMvinResponse", NULL);
	if (soap->error)
...
int OuterRCAVMvinServiceSoapProxy::DoOuterRCAVMvin_(const char *endpoint, const char *soap_action, _ns1__DoOuterRCAVMvin *ns1__DoOuterRCAVMvin, _ns1__DoOuterRCAVMvinResponse &ns1__DoOuterRCAVMvinResponse)
{	struct soap *soap = this;
	struct __ns1__DoOuterRCAVMvin_ soap_tmp___ns1__DoOuterRCAVMvin_;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://tncmes07/COG/ChipMOS/WebService/OuterRCAVMvinService.asmx";
	if (soap_action == NULL)
		soap_action = "http://tempuri.org/DoOuterRCAVMvin";
	soap_tmp___ns1__DoOuterRCAVMvin_.ns1__DoOuterRCAVMvin = ns1__DoOuterRCAVMvin;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___ns1__DoOuterRCAVMvin_(soap, &soap_tmp___ns1__DoOuterRCAVMvin_);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__DoOuterRCAVMvin_(soap, &soap_tmp___ns1__DoOuterRCAVMvin_, "-ns1:DoOuterRCAVMvin", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
