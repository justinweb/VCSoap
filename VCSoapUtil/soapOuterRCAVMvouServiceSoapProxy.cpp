...
int OuterRCAVMvouServiceSoapProxy::DoOuterRCAVMvou(const char *endpoint, const char *soap_action, _VC1__DoOuterRCAVMvou *VC1__DoOuterRCAVMvou, _VC1__DoOuterRCAVMvouResponse &VC1__DoOuterRCAVMvouResponse)
{	struct soap *soap = this;
	struct __VCWeb3__DoOuterRCAVMvou soap_tmp___VCWeb3__DoOuterRCAVMvou;
	if (endpoint)
		soap_endpoint = endpoint;
	...
	soap_tmp___VCWeb3__DoOuterRCAVMvou.VC1__DoOuterRCAVMvou = VC1__DoOuterRCAVMvou;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___VCWeb3__DoOuterRCAVMvou(soap, &soap_tmp___VCWeb3__DoOuterRCAVMvou);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___VCWeb3__DoOuterRCAVMvou(soap, &soap_tmp___VCWeb3__DoOuterRCAVMvou, "-VCWeb3:DoOuterRCAVMvou", "")
